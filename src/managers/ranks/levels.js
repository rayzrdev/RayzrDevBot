...
export class LevelsManager extends Manager {
     ...
     * @returns {Promise<{total: number, currentLevel: number, xpToLevel: number, remaining: number, rank: {place: number, total: number}}>} The user data
     *
     * @memberOf Levels
     */
    async getUserData(id) {
        const total = await this.getXP(id)
        const currentLevel = this.levelFromXP(total)
