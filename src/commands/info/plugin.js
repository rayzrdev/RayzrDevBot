...
import {createEmbed, usageBuilder} from '../../factory'
import {getConfig} from '../../helpers/config'

const apiToken = getConfig().curseforgeAPIToken
...
exports.run = async (bot, msg, args) => {
    ...
    if (sub === 'search') {
        ...
        msg.channel.send({
            embed: createEmbed({ fields: getResults(data) })
